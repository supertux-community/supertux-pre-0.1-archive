...
DESCRIPTION
-----------
  "Super Tux" is a game similar to Super Mario Bros.  Run and jump through
  multiple worlds, fighting off enemies by jumping on them or bumping them
  from below.  Grab upgrades and Linux distributions on the way.
